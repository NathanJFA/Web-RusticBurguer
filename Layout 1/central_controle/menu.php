   ...
   <!--Cabeçalho-->
      ...
      <header>
         ...
         <div class="esquerda_area">
          ...
          <h3>Hamburger <span>Artesanal</span></h3>
          </a>
         </div>
              ...
              <div class="row"><!--Inicio row-->
                <div class="**-danger col-md-3"> <!--inicio lado left-->
                     <div class="row"><!--inicio row interna-->
                        ...
                        <ul>
                        <li><a href="#" class="iniciof">Menu</a></li>
                ...
                <div class="row">
                 <div class=" blocos"><!--inicio col0-->
                 <div class="">
                 <a href="pedidos.php">
                 <center><i class="fas fa-shopping-bag"></i></center>
                    <h5>Meus pedidos</h5>
                 </a>
                 </div>
                 </div><!--fim col0-->

               <div class=" blocos"><!--inicio col1-->
               <div class="">
               <a href="feedback.php">
                <center><i class="fas fa-comment"></i></center>
                    <h5>feedback</h5>
               </a>
               </div>
               </div><!--fim col1-->

               <div class=" blocos"><!--inicio col2-->
               <div class="">
                <a href="info.php">
               ...
               <div class=" blocos"><!--inicio col4-->
               <div class="">
                <a href="endereco.php">
                    <center><i class="fas fa-map-marked-alt"></i></center>
                    <h5>Meus Endereços</h5>
                </a>
               </div>
               </div><!--fim col4-->

               <div class=" blocos"><!--inicio col5-->
               <div class="">
                <a href="card.php">
                  <center><i class="fas fa-credit-card"></i></center>
                    <h5>Cartões</h5>
                </a>
               </div>
               </div><!--fim col5-->
