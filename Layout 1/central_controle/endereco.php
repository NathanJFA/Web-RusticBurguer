...
<head>
  ...
  <!-- Bootstrap CSS -->
   ...
   <link rel="icon" href="icon/endereco.png">
</head>
<body id="End">
   ...
   <!--Cabeçalho-->
          ...
          <div class="botao_right dropdown"><!--inicio btn-right-drop-->
            ...
            <a href="#" class="nav-link dropdown-toggle text-light" data-toggle="dropdown">Olá, <?php echo($_SESSION['user_logado']) ?>!</a> 
                  <div class="dropdown-menu">
                      <a href="menu.php" class="dropdown-item">Ínicio</a>
      ...
      <div class=""><!--inicio content-->
              ...
              <div class="container-fluid lupa">
              ...
              <div class="row"><!--Inicio row-->
                <div class="**-danger col-md-3"> <!--inicio lado left-->
                     <div class="row"><!--inicio row interna-->
                        ...
                        <li><a href="#" class="enD">Meus Endereços</a></li>
                        <li><a href="card.php">Cartões</a></li>
                        <li><a href="../index.php?exit=true">Sair</a></li>
                        </ul>
                        </div><!--fim grupo-->
                        </div><!--fim col-->
                     </div><!--fim row interna-->
                ...
                <div class="row">
                  <div class="card col-md-12">
                    <div class="end">
                    <?php
                        //AQUI PRECISA DE UM FOR NA LISTA DE CLIENTES
                        if(consultAddress() == null){
                      ?>
                      <h3>Endereço Principal</h3>
                      <!--se não tive um endereço o small tem que está ativado-->
                      <small>Você ainda não possui nenhum produto favorito, <a href="../finalizar.php?intention=only_register" class="text-danger">Adicionar endereço</a></small>
                      ...
                      <?php
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th>Bairro</td>
                            <td><?php echo($address['bairro'])?></td>
                          </tr>
                          <tr>
                            <th>Ponto de Rêferencia</td>
                            <td><?php echo($address['ponto_referencia'])?></td>
                          </tr>
                        </tbody>
                        </table>
                        <small>Se deseja alterar o endereço, <a href="../finalizar.php?intention=change_address" class="text-danger">Clique aqui</a></small>
                      <?php
                      }
                      ?>
