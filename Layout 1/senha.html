...
<head>
  ...
  <!-- Bootstrap CSS -->
   ...
   <link rel="icon" href="icon/senha.png"> 
   ...
   <!--Cabeçalho-->
      ...
      <header>
         ...
         <div class="botao_right d-none">
          <a href="carinho.html" class="nav-link text-light"> Entrar</a>
         </div>
      ...
      <div class=" container mb-5"><!--inicio content-->
              ...
              <h4><strong>Esqueçeu sua senha ?</strong></h4>
              <small>Para recuperar sua senha digite seu e-mail. Enviaremos um link pro seu email para redefinir</small>
