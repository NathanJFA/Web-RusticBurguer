...
<body id="Cup">
      ...
      <input type="checkbox" id="check2" checked="true">
         ...
         <a href="admin.php"><i class="fas fa-users-cog"></i></i><span>Admins</span></a>
          <a href="#" class="cup"><i class="fas fa-receipt"></i><span>Cupom</span></a>
      ...
      <div class="content top2"><!--inicio content-->
              <!--alertas-->
       <div class="container d-none">
         ...
         <strong class="lead">Falha ao excluir o usúario!</strong>
          ...
          <div class="containerr"><!--inicio containerr-->
             
             <div class="fundo ">
             <div class="mt-3"><!--tabela-->

                      <div class="">
                  <form action="config_admin.php?intention=generateCoupon">
                    <h6>Gerador de Cupom</h6>
                   
                    <input type="text" name="name" class="form-controll" placeholder="Insira o nome do cupom, Exemplo: RUSTIC">
                   
                    <input type="number" name="value" class="form-controll" placeholder="Insira um valor inteiro" min='100'>
                    
                    <input type="text" name="date_expiration" id="date" placeholder="Exemplo: 00/00/0000" class="form-controll">
                    <button type="submit" onclick="addCoupon()" class="btn btn-outline-dark form-controll mb-1">Gerar</button>
                  </form>
                  </div>
...
<!--
                    ...
                    <!--inicio botão-->
<!--
                    <input type="checkbox" class="liga-desliga-checkbox" id="liga-desliga" checked="true">
...
<!--
                    ...
                    <td class="text-center"> <button type="button" class="btn btn-danger btn-sm"><i class="far fa-times-circle"></i></button> </td>
